...
import {
  ...
  ThirdPartyBalanceCertificateReportRow,
...
export function ThirdPartyBalanceCertificateReport() {
  ...
  const onDownload = React.useCallback(async () => {
    if (!result) return;
    await exportToExcel<ThirdPartyBalanceCertificateReportRow>(
      {
        title: 'Certificado de saldo del tercero',
        filename: `certificado-saldo-tercero-${result.cutoffDate}`,
        columns: [
  ...
  return (
    <>
      <PageHeader
        title="Certificado de saldo del tercero"
        description="Genere reporte en Excel para certificado de saldo consolidado por tercero."
      />
      <PageContent>
        <Card>
          <CardHeader>
