...
import { useProcessAccountingInterfaceCredits } from '@/hooks/queries/use-accounting-interface-queries';
import {
...
export function InterfaceAccountingCredits() {
  ...
  const { mutateAsync: processCredits, isPending: isProcessing } =
    useProcessAccountingInterfaceCredits();

  const onSubmit = async (values: FormValues) => {
    const response = await processCredits({ body: values });
  ...
  return (
    <>
      <PageHeader
        title="Interface contable - Creditos"
      ...
      <PageContent>
        <Card>
          <CardHeader>
            ...
            <CardDescription>Capture los datos para procesar la interface de creditos.</CardDescription>
          </CardHeader>
          <CardContent>
