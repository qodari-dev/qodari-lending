...
export const env = createEnv({
  ...
  server: {
    ...
    COMFENALCO_APP_IDENTIFICADOR: z.string().optional(),
    COMFENALCO_APP_CLAVE: z.string().optional(),
    SYSEU_URL: z.url().optional(),
    SYSEU_API_KEY: z.string().optional(),
    REDIS_URL: z.url(),
    PAUSE_SCHEDULER: z
      .union([z.literal('true'), z.literal('false'), z.literal('1'), z.literal('0')])
      .optional(),
    BILLING_CONCEPTS_CRON: z.string().optional().default('13 0 * * *'),
    BILLING_AGREEMENT_EMAIL_CRON: z.string().optional().default('30 6 * * *'),
  ...
  runtimeEnv: {
    ...
    SUBSIDY_PROVIDER: process.env.SUBSIDY_PROVIDER,
    ...
    SYSEU_URL: process.env.SYSEU_URL,
    SYSEU_API_KEY: process.env.SYSEU_API_KEY,
    REDIS_URL: process.env.REDIS_URL,
    PAUSE_SCHEDULER: process.env.PAUSE_SCHEDULER,
    BILLING_CONCEPTS_CRON: process.env.BILLING_CONCEPTS_CRON,
    BILLING_AGREEMENT_EMAIL_CRON: process.env.BILLING_AGREEMENT_EMAIL_CRON,
