...
import { RepaymentMethodRowActions } from './repayment-method-row-actions';
...
// Column Definitions
// ============================================================================
export const repaymentMethodColumns: ColumnDef<RepaymentMethod>[] = [
  {
    accessorKey: 'name',
  ...
  {
    id: 'actions',
    cell: ({ table, row }) => <RepaymentMethodRowActions row={row} table={table} />,
  },
];
