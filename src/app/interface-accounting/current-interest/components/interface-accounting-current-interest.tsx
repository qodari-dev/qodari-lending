...
import { useProcessAccountingInterfaceCurrentInterest } from '@/hooks/queries/use-accounting-interface-queries';
import {
...
export function InterfaceAccountingCurrentInterest() {
  ...
  const { mutateAsync: processCurrentInterest, isPending: isProcessing } =
    useProcessAccountingInterfaceCurrentInterest();
      ...
      <PageContent>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Capture los datos para procesar la interface de interes corriente.
            </CardDescription>
          </CardHeader>
          <CardContent>
