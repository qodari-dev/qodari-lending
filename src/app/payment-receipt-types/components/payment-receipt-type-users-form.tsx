...
import {
  ...
  UserPaymentReceiptTypeInput,
  UserPaymentReceiptTypeInputSchema,
...
export function PaymentReceiptTypeUsersForm() {
  ...
  const dialogForm = useForm<UserPaymentReceiptTypeInput>({
    resolver: zodResolver(UserPaymentReceiptTypeInputSchema),
    defaultValues: {
      userId: undefined,
      userName: '',
      isDefault: false,
  ...
  const onSave = (values: UserPaymentReceiptTypeInput) => {
    const isDuplicate = fields.some(
      (f, idx) => f.userId === values.userId && idx !== editingIndex
    );
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground text-sm">
            Seleccione maximo dos usuarios habilitados para este tipo de recibo.
          </p>
        </div>
          ...
          <DialogContent ref={dialogContentRef}>
            ...
            <div className="space-y-3">
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <FieldLabel htmlFor="isDefault">Default?</FieldLabel>
                    <div>
                      <Switch
                        checked={field.value}
          ...
          <TableBody>
            {fields.map((field, index) => (
              <TableRow key={field.id}>
                ...
                <TableCell>{field.isDefault ? 'Si' : 'No'}</TableCell>
                <TableCell>
