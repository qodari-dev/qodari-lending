...
import { useProcessAccountingInterfaceProvision } from '@/hooks/queries/use-accounting-interface-queries';
import {
  ProcessAccountingInterfaceProvisionBodySchema,
  ProcessAccountingInterfaceProvisionResult,
...
const FormSchema = ProcessAccountingInterfaceProvisionBodySchema;
...
export function InterfaceAccountingProvision() {
  const [result, setResult] = React.useState<ProcessAccountingInterfaceProvisionResult | null>(null);
  ...
  const { mutateAsync: processProvision, isPending: isProcessing } =
    useProcessAccountingInterfaceProvision();

  const onSubmit = async (values: FormValues) => {
    const response = await processProvision({ body: values });
  ...
  return (
    <>
      <PageHeader
        title="Interface contable - Provision"
      ...
      <PageContent>
        <Card>
          <CardHeader>
            ...
            <CardDescription>Capture los datos para procesar la interface de provision.</CardDescription>
          </CardHeader>
          <CardContent>
