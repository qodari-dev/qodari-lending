...
const FormSchema = GenerateCancelledRejectedCreditsReportBodySchema;
type FormValues = z.infer<typeof FormSchema>;

export function CancelledRejectedCreditsReport() {
  const [result, setResult] = React.useState<GenerateCancelledRejectedCreditsReportResult | null>(
    null
  );
  ...
  const { mutateAsync: generateReport, isPending: isGenerating } =
    useGenerateCancelledRejectedCreditsReport();
