...
interface RowActionsProps {
  row: Row<PaymentTenderType>;
  table: Table<PaymentTenderType>;
}

export function PaymentTenderTypeRowActions({ row, table }: RowActionsProps) {
  const canUpdate = useHasPermission('payment-tender-types:update');
  const canDelete = useHasPermission('payment-tender-types:delete');
