...
interface RowActionsProps {
  row: Row<BillingEmailTemplate>;
  table: Table<BillingEmailTemplate>;
}

export function BillingEmailTemplateRowActions({ row, table }: RowActionsProps) {
  const canUpdate = useHasPermission('billing-email-templates:update');
  const canDelete = useHasPermission('billing-email-templates:delete');
