...
import { useProcessAccountingInterfaceWriteOff } from '@/hooks/queries/use-accounting-interface-queries';
import {
  ProcessAccountingInterfaceWriteOffBodySchema,
  ProcessAccountingInterfaceWriteOffResult,
...
const FormSchema = ProcessAccountingInterfaceWriteOffBodySchema;
...
export function InterfaceAccountingWriteOff() {
  const [result, setResult] = React.useState<ProcessAccountingInterfaceWriteOffResult | null>(null);
  ...
  const { mutateAsync: processWriteOff, isPending: isProcessing } =
    useProcessAccountingInterfaceWriteOff();

  const onSubmit = async (values: FormValues) => {
    const response = await processWriteOff({ body: values });
  ...
  return (
    <>
      <PageHeader
        title="Interface contable - Castiga cartera"
      ...
      <PageContent>
        <Card>
          <CardHeader>
            ...
            <CardDescription>Capture los datos para procesar la interface de castiga cartera.</CardDescription>
          </CardHeader>
          <CardContent>
