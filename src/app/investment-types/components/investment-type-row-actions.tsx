...
interface RowActionsProps {
  row: Row<InvestmentType>;
  table: Table<InvestmentType>;
}

export function InvestmentTypeRowActions({ row, table }: RowActionsProps) {
  const canUpdate = useHasPermission('investment-types:update');
  const canDelete = useHasPermission('investment-types:delete');
