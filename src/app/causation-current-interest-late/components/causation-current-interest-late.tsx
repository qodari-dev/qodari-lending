...
import { useProcessCausationLateInterest } from '@/hooks/queries/use-causation-queries';
import {
  ProcessCausationLateInterestBodySchema,
  ProcessCausationLateInterestResult,
...
export function CausationCurrentInterestLate() {
  const [result, setResult] = React.useState<ProcessCausationLateInterestResult | null>(null);
