...
import { useProcessAccountingInterfacePayments } from '@/hooks/queries/use-accounting-interface-queries';
import {
  ProcessAccountingInterfacePaymentsBodySchema,
  ProcessAccountingInterfacePaymentsResult,
...
const FormSchema = ProcessAccountingInterfacePaymentsBodySchema;
...
export function InterfaceAccountingPayments() {
  const [result, setResult] = React.useState<ProcessAccountingInterfacePaymentsResult | null>(null);
  ...
  const { mutateAsync: processPayments, isPending: isProcessing } =
    useProcessAccountingInterfacePayments();

  const onSubmit = async (values: FormValues) => {
    const response = await processPayments({ body: values });
  ...
  return (
    <>
      <PageHeader
        title="Interface contable - Abonos"
      ...
      <PageContent>
        <Card>
          <CardHeader>
            ...
            <CardDescription>Capture los datos para procesar la interface de abonos.</CardDescription>
          </CardHeader>
          <CardContent>
