...
import { ThirdParties } from '@/server/db';
import { initContract } from '@ts-rest/core';

const c = initContract();
const resourceKey = 'third-parties';

export const thirdParty = c.router(
  {
    list: {
      method: 'GET',
      path: '/',
      query: ListThirdPartiesQuerySchema,
      metadata: {
        auth: 'required',
        permissionKey: {
          resourceKey,
      ...
      responses: {
        200: c.type<Paginated<ThirdParties>>(),
    ...
    getById: {
      ...
      query: GetThirdPartyQuerySchema,
      metadata: {
        auth: 'required',
        permissionKey: {
          resourceKey,
    ...
    create: {
      method: 'POST',
      path: '/',
      body: CreateThirdPartyBodySchema,
      metadata: {
        auth: 'required',
        permissionKey: {
          resourceKey,
    ...
    update: {
      ...
      pathParams: IdParamSchema,
      body: UpdateThirdPartyBodySchema,
      metadata: {
        auth: 'required',
        permissionKey: {
          resourceKey,
