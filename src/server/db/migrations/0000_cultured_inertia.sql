...
CREATE TYPE "public"."billing_concept_type" AS ENUM('PRINCIPAL', 'INTEREST', 'LATE_INTEREST', 'FEE', 'INSURANCE', 'GUARANTEE', 'OTHER');--> statement-breakpoint
...
CREATE TYPE "public"."loan_approval_type" AS ENUM('IMMEDIATE', 'NON_IMMEDIATE');--> statement-breakpoint
...
CREATE TABLE "accounting_entries" (
	...
	"voucher_number" varchar(13) NOT NULL,
	...
	"due_date" date,
	"check_number" varchar(7),
	"status_code" varchar(1) NOT NULL,
	"transaction_type_code" varchar(1),
	"transaction_document" varchar(7) NOT NULL,
...
CREATE TABLE "aging_profiles" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "chk_aging_profiles_effective_order" CHECK ("aging_profiles"."effective_to" IS NULL OR "aging_profiles"."effective_from" IS NULL OR "aging_profiles"."effective_from" <= "aging_profiles"."effective_to")
);
--> statement-breakpoint
CREATE TABLE "agreements" (
	"id" serial PRIMARY KEY NOT NULL,
	"legacy_idecon" varchar(7) NOT NULL,
...
CREATE TABLE "billing_cycle_profiles" (
	...
	CONSTRAINT "chk_billing_cycle_profiles_effective_order" CHECK ("billing_cycle_profiles"."effective_to" IS NULL OR "billing_cycle_profiles"."effective_from" IS NULL OR "billing_cycle_profiles"."effective_from" <= "billing_cycle_profiles"."effective_to")
);
--> statement-breakpoint
...
CREATE TABLE "co_debtors" (
	...
	"home_city_code" varchar(20) NOT NULL,
	"home_phone" varchar(20) NOT NULL,
	"company_name" varchar(80) NOT NULL,
	"work_address" varchar(80) NOT NULL,
	"work_city_code" varchar(20) NOT NULL,
...
CREATE TABLE "credit_product_billing_concepts" (
	...
	"charge_order" integer DEFAULT 0 NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "credit_product_late_interest_rules" (
	"id" serial PRIMARY KEY NOT NULL,
	"credit_product_category_id" integer NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "credit_product_required_documents" (
	"id" serial PRIMARY KEY NOT NULL,
	"credit_product_id" integer NOT NULL,
	"required_document_type_id" integer NOT NULL,
...
CREATE TABLE "credit_products" (
	...
	"study_fee_amount" numeric(14, 2),
	"study_gl_account_id" integer,
	"cost_center_id" integer,
...
CREATE TABLE "credits_settings" (
	...
	"default_collection_method_id" integer NOT NULL,
	"default_cost_center_id" integer,
	"treasury_document_number" varchar(13),
	...
	"default_repayment_method_id" integer,
	"default_guarantee_type_id" integer,
	"legacy_default_subsidy_mark" varchar(2),
	"software_license_number" varchar(20),
	"max_amount" integer,
	"max_installments" integer,
	"default_insurance_value" integer,
	"next_consecutive" integer,
	"fund_register_tax_id" varchar(17),
	"fund_register_factor" numeric(5, 2),
	"fund_register_gl_account_id" integer,
	"bank_account_number" varchar(25),
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "credits_settings_code_unique" UNIQUE("code")
);
--> statement-breakpoint
...
CREATE TABLE "loan_application_pledges" (
	...
	"loan_application_id" integer NOT NULL,
	"agreement_code" varchar(20) NOT NULL,
	"spouse_document_number" varchar(20),
...
CREATE TABLE "loan_applications" (
	...
	"approval_type" "loan_approval_type",
	...
	"channel_id" integer,
	CONSTRAINT "loan_applications_code_unique" UNIQUE("code")
);
--> statement-breakpoint
...
CREATE TABLE "loan_payments" (
	...
	"movement_type_snapshot" "payment_receipt_movement_type",
	...
	"payroll_payer_tax_id" varchar(15),
	"created_by_user_id" uuid NOT NULL,
	...
	"note" varchar(255),
	"legacy_valmay" integer,
	"gl_account_id" integer,
	"is_interfaced" boolean DEFAULT false NOT NULL,
	"legacy_sub43_mark" varchar(2),
	"legacy_sub43_document" varchar(8),
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "loans" (
	...
	"fund_register_tax_id" varchar(20),
	"fund_register_value" numeric(14, 2),
...
ALTER TABLE "credit_product_billing_concepts" ADD CONSTRAINT "credit_product_billing_concepts_override_rule_id_billing_concept_rules_id_fk" FOREIGN KEY ("override_rule_id") REFERENCES "public"."billing_concept_rules"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "credit_product_late_interest_rules" ADD CONSTRAINT "credit_product_late_interest_rules_credit_product_category_id_credit_product_categories_id_fk" FOREIGN KEY ("credit_product_category_id") REFERENCES "public"."credit_product_categories"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "credit_product_required_documents" ADD CONSTRAINT "credit_product_required_documents_credit_product_id_credit_products_id_fk" FOREIGN KEY ("credit_product_id") REFERENCES "public"."credit_products"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "credit_product_required_documents" ADD CONSTRAINT "credit_product_required_documents_required_document_type_id_document_types_id_fk" FOREIGN KEY ("required_document_type_id") REFERENCES "public"."document_types"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "credit_products" ADD CONSTRAINT "credit_products_study_gl_account_id_gl_accounts_id_fk" FOREIGN KEY ("study_gl_account_id") REFERENCES "public"."gl_accounts"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "credits_settings" ADD CONSTRAINT "credits_settings_default_collection_method_id_payment_tender_types_id_fk" FOREIGN KEY ("default_collection_method_id") REFERENCES "public"."payment_tender_types"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "credits_settings" ADD CONSTRAINT "credits_settings_default_repayment_method_id_repayment_methods_id_fk" FOREIGN KEY ("default_repayment_method_id") REFERENCES "public"."repayment_methods"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "credits_settings" ADD CONSTRAINT "credits_settings_default_guarantee_type_id_payment_guarantee_types_id_fk" FOREIGN KEY ("default_guarantee_type_id") REFERENCES "public"."payment_guarantee_types"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "credits_settings" ADD CONSTRAINT "credits_settings_fund_register_gl_account_id_gl_accounts_id_fk" FOREIGN KEY ("fund_register_gl_account_id") REFERENCES "public"."gl_accounts"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "loan_application_documents" ADD CONSTRAINT "loan_application_documents_required_document_type_id_document_types_id_fk" FOREIGN KEY ("required_document_type_id") REFERENCES "public"."document_types"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "loan_process_states" ADD CONSTRAINT "loan_process_states_last_process_run_id_process_runs_id_fk" FOREIGN KEY ("last_process_run_id") REFERENCES "public"."process_runs"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "payment_allocation_policy_rules" ADD CONSTRAINT "payment_allocation_policy_rules_policy_id_payment_allocation_policies_id_fk" FOREIGN KEY ("policy_id") REFERENCES "public"."payment_allocation_policies"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_entries_loan_installment_due_status" ON "accounting_entries" USING btree ("loan_id","installment_number","due_date","status_code");--> statement-breakpoint
CREATE INDEX "idx_entries_gl_third_party_status" ON "accounting_entries" USING btree ("gl_account_id","third_party_id","status_code");--> statement-breakpoint
CREATE INDEX "idx_entries_voucher" ON "accounting_entries" USING btree ("voucher_number","entry_date");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uniq_agreements_legacy_idecon" ON "agreements" USING btree ("legacy_idecon");--> statement-breakpoint
CREATE UNIQUE INDEX "uniq_agreements_agreement_code" ON "agreements" USING btree ("agreement_code");--> statement-breakpoint
CREATE INDEX "idx_agreements_nit" ON "agreements" USING btree ("nit");--> statement-breakpoint
CREATE INDEX "idx_agreements_status" ON "agreements" USING btree ("status_code");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uniq_co_debtors_document_number" ON "co_debtors" USING btree ("document_type","document_number");--> statement-breakpoint
...
CREATE INDEX "idx_late_rules_category" ON "credit_product_late_interest_rules" USING btree ("credit_product_category_id");--> statement-breakpoint
CREATE INDEX "idx_late_rules_active" ON "credit_product_late_interest_rules" USING btree ("credit_product_category_id","is_active");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uniq_credit_product_required_document" ON "credit_product_required_documents" USING btree ("credit_product_id","required_document_type_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uniq_insurance_companies_tax_id" ON "insurance_companies" USING btree ("tax_id");--> statement-breakpoint
CREATE UNIQUE INDEX "uniq_insurance_rate_range" ON "insurance_rate_ranges" USING btree ("insurance_company_id","value_from","value_to");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uniq_application_document_type" ON "loan_application_documents" USING btree ("loan_application_id","required_document_type_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uniq_pledge_application_beneficiary" ON "loan_application_pledges" USING btree ("loan_application_id","agreement_code","beneficiary_code");--> statement-breakpoint
CREATE INDEX "idx_pledges_application" ON "loan_application_pledges" USING btree ("loan_application_id");--> statement-breakpoint
CREATE INDEX "idx_pledges_agreement" ON "loan_application_pledges" USING btree ("agreement_code");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uniq_loan_payment_receipt" ON "loan_payments" USING btree ("receipt_type_id","code");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uniq_loans_code" ON "loans" USING btree ("code");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uniq_payment_allocation_policies_code" ON "payment_allocation_policies" USING btree ("code");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uniq_payment_alloc_rule_order" ON "payment_allocation_policy_rules" USING btree ("policy_id","priority");--> statement-breakpoint
CREATE INDEX "idx_payment_alloc_rules_policy" ON "payment_allocation_policy_rules" USING btree ("policy_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uniq_portfolio_aging_snapshot" ON "portfolio_aging_snapshots" USING btree ("accounting_period_id","loan_id","gl_account_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "uniq_third_party_identity" ON "third_parties" USING btree ("document_type","document_number");--> statement-breakpoint
