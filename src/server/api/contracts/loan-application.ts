import {
  ...
  GetLoanApplicationApprovalLoadQuerySchema,
  GetLoanApplicationQuerySchema,
  GetLoanApplicationSubsidyPledgeLookupParamsSchema,
  LoanApplicationApprovalLoadResponseSchema,
  LoanApplicationSubsidyPledgeLookupResponseSchema,
  ...
  ReassignLoanApplicationBodySchema,
  ReassignLoanApplicationsBodySchema,
...
export const loanApplication = c.router(
  {
    ...
    inbox: {
      method: 'GET',
      path: '/inbox',
      query: ListLoanApplicationInboxQuerySchema,
      metadata: {
        auth: 'required',
        permissionKey: {
          resourceKey,
    ...
    approvalLoad: {
      method: 'GET',
      path: '/approval-load/by-level',
      query: GetLoanApplicationApprovalLoadQuerySchema,
      metadata: {
        auth: 'required',
        permissionKey: {
          resourceKey,
      ...
      responses: {
        200: LoanApplicationApprovalLoadResponseSchema,
        400: TsRestErrorSchema,
        401: TsRestErrorSchema,
        403: TsRestErrorSchema,
        404: TsRestErrorSchema,
    ...
    subsidyPledgeLookup: {
      method: 'GET',
      path: '/:thirdPartyId/subsidy-pledges/lookup',
      pathParams: GetLoanApplicationSubsidyPledgeLookupParamsSchema,
      metadata: {
        auth: 'required',
        permissionKey: {
          resourceKey,
      ...
      responses: {
        200: LoanApplicationSubsidyPledgeLookupResponseSchema,
        400: TsRestErrorSchema,
        401: TsRestErrorSchema,
        403: TsRestErrorSchema,
        404: TsRestErrorSchema,
    ...
    reassign: {
      method: 'POST',
      path: '/reassign',
      body: ReassignLoanApplicationsBodySchema,
      metadata: {
        auth: 'required',
        permissionKey: {
          resourceKey,
      ...
      responses: {
        200: c.type<{ totalMatched: number; reassignedCount: number }>(),
        400: TsRestErrorSchema,
        401: TsRestErrorSchema,
        403: TsRestErrorSchema,
        409: TsRestErrorSchema,
    ...
    reassignOne: {
      ...
      path: '/:id/reassign',
      pathParams: IdParamSchema,
      body: ReassignLoanApplicationBodySchema,
      metadata: {
        auth: 'required',
        permissionKey: {
          resourceKey,
