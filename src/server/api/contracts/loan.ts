import {
  ...
  LoanSignatureEnvelopePathParamsSchema,
  PresignLoanSignatureFileViewBodySchema,
  PresignLoanSignatureFileViewResponseSchema,
  ResendLoanSignatureEnvelopeBodySchema,
  ResendLoanSignatureEnvelopeResponseSchema,
  ListLoansQuerySchema,
  UpdateLoanBankInfoBodySchema,
  UpdateLoanAgreementBodySchema,
...
export const loan = c.router(
  {
    ...
    presignSignatureFileView: {
      method: 'POST',
      path: '/:id/signature-files/presign-view',
      pathParams: IdParamSchema,
      body: PresignLoanSignatureFileViewBodySchema,
      metadata: {
        auth: 'required',
        permissionKey: {
          resourceKey,
      ...
      responses: {
        200: PresignLoanSignatureFileViewResponseSchema,
        400: TsRestErrorSchema,
        401: TsRestErrorSchema,
        403: TsRestErrorSchema,
        404: TsRestErrorSchema,
    ...
    resendSignatureEnvelope: {
      method: 'POST',
      path: '/:id/signature-envelopes/:envelopeId/resend',
      pathParams: LoanSignatureEnvelopePathParamsSchema,
      body: ResendLoanSignatureEnvelopeBodySchema,
      metadata: {
        auth: 'required',
        permissionKey: {
          resourceKey,
      ...
      responses: {
        200: ResendLoanSignatureEnvelopeResponseSchema,
        400: TsRestErrorSchema,
        401: TsRestErrorSchema,
        403: TsRestErrorSchema,
        404: TsRestErrorSchema,
    ...
    updateAgreement: {
      ...
      path: '/:id/agreement',
      pathParams: IdParamSchema,
      body: UpdateLoanAgreementBodySchema,
      metadata: {
        auth: 'required',
        permissionKey: {
          resourceKey,
