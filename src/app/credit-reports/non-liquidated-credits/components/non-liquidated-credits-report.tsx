    ...
    await exportToExcel<NonLiquidatedCreditsReportRow>(
      {
        ...
        filename: `creditos-no-liquidados-${result.startDate}-${result.endDate}`,
        columns: [
          ...
          { header: 'Dias mora', accessorKey: 'daysPastDue', width: 14 },
        ],
      },
      result.rows
    );
  ...
  return (
    <>
      <PageHeader
        ...
        description="Genere Excel de creditos no liquidados por rango de fechas."
      />
      <PageContent>
        <Card>
          <CardHeader>
