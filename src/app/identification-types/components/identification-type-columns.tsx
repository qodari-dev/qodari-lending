...
import { IdentificationTypeRowActions } from './identification-type-row-actions';
...
// Column Definitions
// ============================================================================
export const identificationTypeColumns: ColumnDef<IdentificationType>[] = [
  {
    accessorKey: 'code',
  ...
  {
    id: 'actions',
    cell: ({ table, row }) => <IdentificationTypeRowActions row={row} table={table} />,
  },
];
