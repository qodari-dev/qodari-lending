...
import { useProcessCausationCurrentInsurance } from '@/hooks/queries/use-causation-queries';
import {
  ProcessCausationCurrentInsuranceBodySchema,
  ProcessCausationCurrentInsuranceResult,
...
export function CausationCurrentInsurance() {
  const [result, setResult] = React.useState<ProcessCausationCurrentInsuranceResult | null>(null);
  ...
  const onSubmit = async (values: FormValues) => {
    const response = await processCurrentInsurance({ body: values });
