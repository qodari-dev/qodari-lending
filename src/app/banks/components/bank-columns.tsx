...
export const bankColumns: ColumnDef<Bank>[] = [
  ...
  {
    accessorKey: 'asobancariaCode',
    header: ({ column }) => <DataTableColumnHeader column={column} title="Código Asobancaria" />,
    cell: ({ row }) => {
      return (
        <div className="flex flex-col">
          <span className="font-mono">{row.original.asobancariaCode}</span>
        </div>
      );
    },
  },
  ...
  {
    id: 'actions',
    cell: ({ table, row }) => <BankRowActions row={row} table={table} />,
  },
];
