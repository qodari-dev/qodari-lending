...
import { InvestmentTypeRowActions } from './investment-type-row-actions';
...
// Column Definitions
// ============================================================================
export const investmentTypeColumns: ColumnDef<InvestmentType>[] = [
  {
    accessorKey: 'name',
  ...
  {
    id: 'actions',
    cell: ({ table, row }) => <InvestmentTypeRowActions row={row} table={table} />,
  },
];
