...
export const UpdateCreditsSettingsBodySchema = z.object({
  ...
  provisionExpenseGlAccountId: z.number().nullable().optional(),
  portfolioProvisionGlAccountId: z.number().nullable().optional(),
  provisionRecoveryGlAccountId: z.number().nullable().optional(),
