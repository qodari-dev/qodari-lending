...
import { PaymentGuaranteeTypeRowActions } from './payment-guarantee-type-row-actions';
...
// Column Definitions
// ============================================================================
export const paymentGuaranteeTypeColumns: ColumnDef<PaymentGuaranteeType>[] = [
  {
    accessorKey: 'name',
  ...
  {
    id: 'actions',
    cell: ({ table, row }) => <PaymentGuaranteeTypeRowActions row={row} table={table} />,
  },
];
